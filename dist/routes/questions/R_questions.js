...
const questionsValidation_1 = require("./questionsValidation");
// =================================================
...
router.get('/answers', questionsValidation_1.answersValidation, C_questions_1.default.compareAnswers);
